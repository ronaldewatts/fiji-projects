                        ...
                        .forEach(path -> {
                            ...
                            if (!processedImages.contains(absolutePath)) {
                                ...
                                if (image.getStackSize() == 2) {
                                    ...
                                    IJ.run(slice1, "Scale Bar...", "width=240 height=240 thickness=20 font=14 color=White background=None location=[Lower Right] horizontal bold overlay");
                                    ...
                                    IJ.run(slice2, "Scale Bar...", "width=240 height=240 thickness=20 font=14 color=White background=None location=[Lower Right] horizontal bold overlay");
